    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="mt-6 text-xs text-slate-400 text-center space-y-1">
          <p className="font-semibold text-slate-600">Demo emails:</p>
          <p>admin@empresa.com | rrhh@empresa.com | empleado@empresa.com</p>
          <p className="mt-2">Contraseña para todos: <strong>123456</strong></p>
        </div>
      </div>
    </div>
  );
